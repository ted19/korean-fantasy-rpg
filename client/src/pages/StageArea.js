...
const STAGE_INTRO_SCENES = {
  ...
  '승려': [
    ...
    },
    {
      bg: '/stages/silla_bg.png',
      speaker: '나레이션',
      text: '삼국의 전장에서 흘린 피가 대지를 물들이고, 그 위에서 마물이 태어났다. 승려의 진언과 결계만이 이를 정화할 수 있다.',
    },
    {
      bg: '/stages/silla_bg.png',
      speaker: '승려',
      text: '진언으로 마물을 정화하고, 결계로 영혼을 천도하겠다. 각 시대의 업장을 걷어내야 한다.',
    },
    {
      bg: '/stages/silla_bg.png',
      speaker: '나레이션',
      text: '승려는 목탁을 두드리며 첫 번째 시대의 문을 열었다. 법력의 진언과 자비의 결계로 역사를 정화하는 수행이 시작되었다.',
    },
  ],
  '저승사자': [
    {
  ...
  '북채비': [
    {
      bg: '/stages/stage_map_bg.png',
      speaker: '나레이션',
      text: '마을을 지키던 북채비가 더 넓은 세상의 위협을 감지했다. 시대를 넘어 전장이 펼쳐져 있었다.',
    },
    {
      bg: '/stages/gojoseon_bg.png',
      speaker: '북채비',
      text: '이 땅에 서린 전쟁의 기운... 과거의 전장에서 마물이 태어나고 있군. 내 방패로 모두 막아내겠다.',
    },
    {
      bg: '/stages/gojoseon_bg.png',
      speaker: '나레이션',
      text: '고조선부터 이어진 전쟁의 상처. 북채비의 거대 방패만이 그 상처를 막고 땅을 치유할 수 있다.',
    },
    {
      bg: '/stages/gojoseon_bg.png',
      speaker: '북채비',
      text: '좋다. 각 시대의 전장을 돌파하며 마물을 소탕하겠다. 이 방패가 있는 한 뒤는 걱정 없다!',
    },
    {
      bg: '/stages/gojoseon_bg.png',
      speaker: '나레이션',
      text: '북채비는 거대 방패를 앞세우고 첫 번째 시대의 전장으로 들어섰다. 대지의 수호자가 역사를 관통하는 여정에 나섰다.',
    },
  ],
  '강신무': [
    {
      bg: '/stages/stage_map_bg.png',
      speaker: '나레이션',
      text: '신령의 인도를 따라 강신무가 시간의 경계에 섰다. 각 시대의 전장에서 강력한 마기가 솟아오르고 있었다.',
    },
    {
      bg: '/stages/samhan_bg.png',
      speaker: '강신무',
      text: '신령이 흥분하고 있어... 이 전장에 서린 원념이 엄청난 마기를 품고 있군. 내 칼에 불꽃을 싣겠다.',
    },
    {
      bg: '/stages/samhan_bg.png',
      speaker: '나레이션',
      text: '삼한 시대부터 축적된 전쟁의 원념. 강신무의 화염 신칼만이 그 원념을 태워 정화할 수 있다.',
    },
    {
      bg: '/stages/samhan_bg.png',
      speaker: '강신무',
      text: '좋아! 신령이여, 내게 힘을 빌려다오. 각 시대의 마물을 내 불꽃으로 소각하겠다!',
    },
    {
      bg: '/stages/samhan_bg.png',
      speaker: '나레이션',
      text: '강신무는 화염에 휩싸인 신칼을 뽑아 들고 첫 번째 시대로 뛰어들었다. 신령과 하나가 되는 뜨거운 전장이 시작되었다.',
    },
  ],
};
